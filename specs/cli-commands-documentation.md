...
- If validate/add tooling is genuinely planned, it may be mentioned only in a clearly-labeled future-work note — default is removal.

## Acceptance Criteria
- [ ] No SDK doc or Makefile references `plugin validate`, `plugin add`, or fixture flags.
